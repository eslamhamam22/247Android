...
public class OrderChildViewHolder extends SectioningAdapter.ItemViewHolder implements View.OnClickListener {
    ...
    public OrderChildViewHolder(View itemView, Context context,OnOrderClickListener onOrderClickListener) {
        super(itemView);
    ...
    private void setFonts() {
      ...
      //  orderNum.setTypeface(fonts.customFont());
        ...
        tv_status.setTypeface(fonts.customFontBD());
